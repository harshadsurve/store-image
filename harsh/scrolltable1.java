...
public class scrolltable1 {
	...
	private static void readempInfo(String string, ResultSet result)  
		...
		throws SQLException{
			...
			String empInfo="%s: %s- %s- %s- %s- %s\n";
			Object position = null;
			System.out.format(empInfo,position,id,name,occupation,age,salary);
		}
